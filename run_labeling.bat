@echo off
rem Launch the production labeling tool (online: login -> fetch -> label -> upload).
rem Double-click, or run from anywhere: run_labeling.bat [args...]  (arguments are passed through)
